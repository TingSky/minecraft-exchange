...
func main() {
	...
	http.HandleFunc("/tasks_data", handlers.GetTasksDataHandler)
	...
	http.HandleFunc("/shop_data", handlers.GetShopDataHandler)
	...
	http.HandleFunc("/admin_data", handlers.GetAdminDataHandler)
